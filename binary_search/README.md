...
This folder contains my Python solutions for problems under the **Binary Search** section of the [NeetCode Roadmap](https://neetcode.io/roadmap).
...
![Binary Search Example](/binary_search/Binary_Search.png)
